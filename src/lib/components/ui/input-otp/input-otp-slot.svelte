...
<InputOTPPrimitive.Cell
  ...
  class={cn(
    "border-field-border bg-field aria-invalid:border-destructive relative flex size-10 items-center justify-center border-y border-r text-sm transition-all outline-none first:rounded-l-md first:border-l last:rounded-r-md",
    cell.isActive &&
